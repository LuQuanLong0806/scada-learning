...
OUT = r"E:\workbudy\2026-07-10-10-35-57\M0_每日讲义_深度版.html"
...
<script>
var TOTAL = __TOTAL__;
function key(n){return 'm0deep_day_'+n;}
...
function syncAll(){
  ...
  document.title='M0深度讲义 '+done+'/'+TOTAL+' · '+pct+'%';
}
...
.content{flex:1;min-width:0;padding:24px 32px 80px;max-width:940px;}
...
<title>DAQ Monitor · M0 深度讲义</title>
%s
</head>
<body>
<div class="topbar">
  <h1>📘 DAQ Monitor · M0 每日讲义（深度版）· 打卡看板</h1>
  <div class="progress">
